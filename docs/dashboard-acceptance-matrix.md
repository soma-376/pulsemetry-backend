...
|---|---|---|
| distribution | 런타임/53개 지원표 대조 완료: 8개 지원·45개 미지원. dashboard-distribution-scope.md에 표본·필드·결정안 작성 | 현재 frontend의 prompts_per_session·gate_wait_ms·S3-2 usage_concentration 모두 지원. 나머지 확장은 현재 연동의 차단 사항이 아님 |
