...
| onboarding_retention | table | 501 | 501 | 연결 |
...
- onboarding_retention의 timeseries 표현, W3.3 주소 테이블과 개인정보 감사 흐름은 추가 대조가 필요하다. 계약 ID 지정 약정 소진율은 366일 초과 요청을 허용하며 미지정·일반 지표·혼합 요청은 기존 제한을 유지한다.
