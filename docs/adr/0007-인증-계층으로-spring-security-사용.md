...
사람 가입·로그인·회전 코어, 키 운영과 보안 수용 기준은 ADR 0018로 구현했다.
CLI callback은 허브 ADR 0007의 일회용 코드+S256 PKCE 방식이며 AT/RT 직접 URL 전달을 대체한다.
초대의 가입 소비와 설치 소비는 독립이다. 웹 화면·실제 CLI와 관리자 인가 전환은 후속이다.
