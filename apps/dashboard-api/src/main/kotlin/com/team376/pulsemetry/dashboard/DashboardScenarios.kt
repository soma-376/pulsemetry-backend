...
class DashboardScenarios(private val mapper: ObjectMapper, private val metrics: DashboardMetricCatalog) {
    ...
    fun list(@RequestParam(required = false) category: String?,
        ...
        @RequestParam(defaultValue = "") q: String): Map<String, Any> {
    ...
    fun detail(@PathVariable scenarioId: String): JsonNode {
