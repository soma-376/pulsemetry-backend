...
class DashboardQuery(private val catalog: DashboardMetricCatalog, private val access: DashboardAccess,
    ...
    private val topGroupMetrics = pointMetrics.keys + topRatioMetrics + topPeriodMetrics + setOf("cost","tokens","tool_calls","rate_limit_events","tool_rejections",
    ...
    private fun readCommitment(q: DashboardQueryItem, scope: Scope, from: Instant, to: Instant,
    ...
    private fun readAbandoned(q: DashboardQueryItem, scope: Scope, from: Instant, to: Instant,
        ...
        ) SELECT stats.*,privacy.people,privacy.active_time_definition
    ...
    private fun readTokens(q: DashboardQueryItem, scope: Scope, from: Instant, to: Instant,
